...
CHOVVA DOSHAM: ${matchResult.chovvaNotes?.map(c=>c.note).join('; ')||'None'}
DASA SANDHI: ${matchResult.dasaSandhi?.warnings?.length?matchResult.dasaSandhi.warnings.join('; '):'No Dasa Sandhi concerns'}
